...
def render_header(page_name: str = "Research QA Engine"):
    ...
    if page_name in ["Research QA Engine", "⌂ Research QA Engine"]:
        # Landing Hero Masthead (Clean, unboxed or slim bordered masthead)
        st.markdown(
            f"""
            <div style="border-bottom: 1px solid #E5E5E3; padding-bottom: 14px; margin-bottom: 18px;">
                <div style="display: flex; justify-content: space-between; align-items: flex-end; flex-wrap: wrap; gap: 12px;">
                    <div>
                        <div class="hero-title" style="font-size: 1.85rem; margin-bottom: 2px;">AI Research Copilot</div>
                        <div class="hero-subtitle" style="margin-bottom: 0; font-size: 0.88rem; color: #525252;">
                    ...
                    <div style="display: flex; gap: 6px; flex-wrap: wrap; align-items: center;">
                        <span class="badge-pill badge-strong" style="font-size: 0.72rem;">
                            {svg_icon("cpu", size=12, color="#1E5631")} Core Engine Active
                        </span>
                        <span class="badge-pill badge-slate" style="font-size: 0.72rem;">
                            {svg_icon("layers", size=12, color="#334155")} Hybrid RRF + Reranker
                        </span>
                        <span class="badge-pill badge-outline" style="font-size: 0.72rem;">
                            {svg_icon("database", size=12, color="#1F2937")} 184 Papers Indexed
                        </span>
                    </div>
                </div>
            </div>
        ...
        st.markdown(
            f"""
            <div style="border-bottom: 1px solid #E5E5E3; padding-bottom: 8px; margin-bottom: 16px; display: flex; justify-content: space-between; align-items: center; font-size: 0.82rem; color: #6B7280;">
                <div style="display: flex; align-items: center; gap: 6px;">
                    <span style="font-weight: 600; color: #111827; font-family: 'Lora', Georgia, serif;">AI Research Copilot</span>
                    <span>/</span>
                    <span style="font-weight: 500; color: #2B4C7E;">{clean_page_name}</span>
                </div>
                <div style="display: flex; gap: 8px; align-items: center; font-size: 0.75rem;">
                    <span>Corpus: <code>184 papers</code></span>
                    <span>·</span>
                    <span style="color: #1E5631;">● Engine Ready</span>
                </div>
            </div>
            """,
            unsafe_allow_html=True
